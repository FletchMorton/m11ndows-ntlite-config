...
# Forked by Fletcher Morton
# MinOS - A Thorough and Customized Windows Debloat
...
### Customized list of Txmmy's GamerOS Tweaks  ###
### Configures Windows To Remove Unneeded Services ###
...
Write-Host "                                                                                                   " -ForegroundColor DarkCyan 
Write-Host "                                                                                                   " -ForegroundColor DarkCyan 
Write-Host "                             A fork of GamerOS by Fletcher Morton                                  " -ForegroundColor White 
Write-Host "                                                                                                   " -ForegroundColor DarkCyan 
Write-Host "                                                                                                   " -ForegroundColor DarkCyan 
Write-Host "                                                                                                   " -ForegroundColor DarkCyan 
Write-Host "                                                                                                   " -ForegroundColor DarkCyan 
...
$host.ui.RawUI.WindowTitle = 'MinOS Debloater'
...
New-Item "C:\MinOS_Settings.reg" -ItemType File  -Value "Windows Registry Editor Version 5.00
...
" | Out-Null
reg import "C:\MinOS_Settings.reg" | Out-Null
}
...
# Manually removes Start Menu programs
Function StartMenuTiles {
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Access.lnk' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Excel.lnk' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\OneNote.lnk' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Outlook.lnk' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Powerpoint.lnk' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Publisher.lnk' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Word.lnk' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Microsoft Office Tools' -Recurse
Remove-Item -Path 'C:\Program Files\Microsoft Office' -Recurse
Remove-Item -Path 'C:\Program Files\Microsoft Office 15' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Booking.com.url' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Amazon.url' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Forge of Empires.url' -Recurse
Remove-Item -Path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Planet9 Link.url' -Recurse
Remove-Item -Path 'C:\Program Files\Windows Defender' -Recurse
Remove-Item -Path 'C:\Program Files\Windows Mail' -Recurse
}
...
"2670RandomSaladGamesLLC.3899848563C1F"
"Microsoft.Services.Store.Engagement"
"F46D4000-FD22-4DB4-AC8E-4E1DDDE828FE"

#Only will affect hardware obtained by certain vendors
